...
# | 
set_module_property DESCRIPTION "A streaming two to one mux"
...
set_module_property DISPLAY_NAME two_to_one_st_mux
...
set_interface_property st_input_A associatedClock clock_reset
...
set_interface_property st_input_A ASSOCIATED_CLOCK clock_reset
...
set_interface_property st_input_B associatedClock clock_reset
...
set_interface_property st_input_B ASSOCIATED_CLOCK clock_reset
...
set_interface_property st_output associatedClock clock_reset
...
set_interface_property st_output ASSOCIATED_CLOCK clock_reset

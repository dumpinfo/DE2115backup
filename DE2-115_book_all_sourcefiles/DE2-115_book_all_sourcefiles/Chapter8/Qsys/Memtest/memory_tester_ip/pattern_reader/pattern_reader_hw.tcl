...
# | 
set_module_property DESCRIPTION "A command based read master that outputs streaming data"
...
set_module_property DISPLAY_NAME pattern_reader
...
set_interface_property command associatedClock clock_reset
...
set_interface_property command ASSOCIATED_CLOCK clock_reset
...
set_interface_property st_data associatedClock clock_reset
...
set_interface_property st_data ASSOCIATED_CLOCK clock_reset
...
set_interface_property mm_data associatedClock clock_reset
...
set_interface_property mm_data ASSOCIATED_CLOCK clock_reset

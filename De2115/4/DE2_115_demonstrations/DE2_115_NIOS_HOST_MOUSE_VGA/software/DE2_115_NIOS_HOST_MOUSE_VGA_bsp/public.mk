...
# setting SOPC_SYSID_BASE_ADDRESS is 0x9200080
SOPC_SYSID_FLAG += --sidp=0x9200080
ELF_PATCH_FLAG  += --sidp 0x9200080

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1354258592
SOPC_SYSID_FLAG += --timestamp=1354258592
ELF_PATCH_FLAG  += --timestamp 1354258592
